...
static int add_persist_attributes(struct device *dev)
{
	...
	if (is_usb_device(dev)) {
		 ...
		 */
		if (udev->descriptor.bDeviceClass != USB_CLASS_HUB)
			/*向power_group属性文件组里面加入dev_attr_persist.attr属性文件*/
...
/**
 * usb_create_sysfs_dev_files:给usb设备创建属性文件
 */
...
/**
 * usb_remove_sysfs_dev_files:删除usb设备属性文件
 */
...
/**
 * usb_create_sysfs_intf_files: 为usb interface创建属性文件
 */
...
/**
 * usb_remove_sysfs_intf_files:删除usb interface的属性文件
 */
