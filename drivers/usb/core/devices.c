 ...
 *   本文件功能：
 *		1.提供usbfs文件系统的文件操作的结构
 *		2.主要实现读取usb设备相关信息的结构
 *		  并返回给用户空间.
 */
...
/**
 * usb_dump_endpoint_descriptor:复制usb设备的endpoint信息到用户空间处
 */
...
/**
 * usb_dump_interface_descriptor:复制usb设备的interface描述符信息到用户空间
 */
...
/**
 * usb_dump_interface:复制usb设备的interface信息到用户空间
 */
...
/**
 * usb_dump_iad_descriptor:复制usb设备的iad描述符信息到用户空间
 */
...
/**
 * usb_dump_config_descriptor:复制usb设备的configuration描述符信息到用户空间
 */
...
/**
 * usb_dump_config:复制usb设备的configuration信息到用户空间
 */
			     ...
			     const struct usb_host_config *config, int active)
{
	...
	/*复制configuration中所有的intrface信息*/
	for (i = 0; i < config->desc.bNumInterfaces; i++) {
		intfc = config->intf_cache[i];     /*usb设备的altting接口信息*/
		interface = config->interface[i]; /*usb设备的原始接口信息*/
...
/*
 * usb_dump_device_descriptor: 复制usb设备描述符到start开始的
 * 的内存空间
 * @ start: 内存的开始地址
 * @ end:   内存的结束地址
 * @ desc:　usb设备描述符
...
/*
 * usb_dump_device_strings:复制usb设备的字符串描述符信息
 * @ start: 保存字符串信息内存起始地址
 * @ end:　 内存结束地址
 * @ dev:
 */
...
/**
 * usb_dump_desc:复制usb设备描述符到start开始的内存处
 */
...
/**
 * usb_dump_hub_descriptor:复制hub描述符信息到用户空间
 */
...
/**
 * usb_dump_string:复制usb设备的string描述符信息到用户空间
 */
...
#endif /* PROC_EXTRA */
/**
 * usb_device_dump: 复制usbdev设备(包括其孩子)的描述信息到用户空间
 * 这些描述信息包括：configuration interface endpoint等信息
 * @ buffer:
 * @ nbytes: 
 * @ skip_bytes:
 * @ file_offset:
...
/**
 * usb_device_read:读取注册到usb_bus_list中的bus的所有usb设备信息到用户空间
 */
...
/*usbfs文件系统中根目录下"devices"文件节点和
 *debufs调试文件系统中usb的 "devices"文件节点
 *的操作函数接口
*/
