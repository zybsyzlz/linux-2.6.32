...
/**
 * bus_create_file:在bus->p->subsys.kobj目录下创建属性文件
*/
...
/**
 * @ driver_add_attrs: 给drv增加bus属性的文件
 * @ bus: drv所属的bus
 * @ drv:
 * @ 在drv->p->kobj目录下创建bus属性文件
*/
...
/**
 * bus增加通知链,将nb连入bus->p->bus_notifier的通知链表中
 */
