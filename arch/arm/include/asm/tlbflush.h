...
/**
 * flush_pmd_entry:刷新pmd
 * 注：
 *   1. 清空pmd data cache line
 *   2. 回写write buffer
*/
static inline void flush_pmd_entry(pmd_t *pmd)
{
	...
	if (tlb_flag(TLB_DCLEAN))
		asm("mcr	p15, 0, %0, c7, c10, 1	@ flush pmd data cache line"
			: : "r" (pmd) : "cc");
...
/**
 * clean_pmd_entry:清空pmd的data cache line
 * 注:只清空cache 但是不回写write buffer
*/
